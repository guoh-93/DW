...
namespace ERPreport
{
    public partial class 借用申请 : Form
    {
        public 借用申请()
        {
            InitializeComponent();
        ...
        private void 借用申请_Load(object sender, EventArgs e)
        {
            fun();
        ...
        private void fun()
        {
            ...
            try
            {
                ...
                reportViewer1.LocalReport.ReportPath = "Report借用申请.rdlc";
                    ...
                    new ReportParameter("原因分类",dr1["原因分类"].ToString()),
                     ...
                     new ReportParameter("申请日期",DateTime.Parse( dr1["申请日期"].ToString()).ToString("yyyy-MM-dd")),
                          ...
                          new ReportParameter("申请人",dr1["申请人"].ToString()),
                           ...
                           new ReportParameter("片区",dr1["片区"].ToString()),

                          new ReportParameter("借用人",dr1["借用人员"].ToString()),
                     new ReportParameter("备注",dr1["备注"].ToString()),
                      new ReportParameter("目标客户",dr1["目标客户"].ToString()),

                     new ReportParameter("收货地址",dr1["地址"].ToString()),
                        new ReportParameter("相关单位",dr1["相关单位"].ToString()),
              
                      new ReportParameter("物流信息",dr1["物流信息"].ToString()),
