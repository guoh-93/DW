...
namespace ERPreport
{
    public partial class 退货打印 : Form
    {
        public 退货打印()
        {
            InitializeComponent();
        ...
        private void 退货打印_Load(object sender, EventArgs e)
        {
            fun();
        ...
        private void fun()
        {
            ...
            try
            {
                ...
                reportViewer1.LocalReport.ReportPath = "Report退货.rdlc";
         ...
         new ReportParameter("退货入库单号",dr1["退货入库单号"].ToString()),
         new ReportParameter("客户",dr1["客户"].ToString()),
         new ReportParameter("退货类型",dr1["退货类型"].ToString()),
         new ReportParameter("申请人",dr1["操作人员"].ToString()),
          
         new ReportParameter("备注",dr1["备注"].ToString()),
                   new ReportParameter("入库日期",DateTime.Now.ToString("yyyy-MM-dd")),
