...
namespace IAACA
{
    public partial class ui销售统计表 : UserControl
    {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            try
            {
                string sql = string.Format(" exec xstj '{0}' ,'{1}'", dateEdit1.EditValue, Convert.ToDateTime(dateEdit2.EditValue).AddDays(1));
        ...
        private void ui销售统计表_Load(object sender, EventArgs e)
        {
