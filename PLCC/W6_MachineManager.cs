...
namespace PLCC
{
    public static class W6_MachineManager
    {

        #region
        public static List<W6_MachineAdapter> li_MachineAdapter = new List<W6_MachineAdapter>();    //组队MachineAdapter控制器
        ...
        static void tm_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            try
            {
                lock (li_MachineAdapter)
                {
                    ...
                    ///先判断Manager是否组队模式工作
                    foreach (W6_MachineAdapter mm in li_MachineAdapter)
                    {
                        if (mm.blTeam == true)
                        {
        ...
        public static W6_MachineAdapter CheckMachineExists(string MachineName)
        {
            foreach (W6_MachineAdapter ma in li_MachineAdapter)
            {
        ...
        public static void addMachine(W6_MachineAdapter ma)
        {
